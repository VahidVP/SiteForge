...
function Brand() {
  ...
  const showImage = site.logo && (site.logoMode === 'image' || site.logoMode === 'both')
  const showText = !site.logo || site.logoMode === 'text' || site.logoMode === 'both'
  return (
    <NavLink to="/" className="brand">
      {showImage ? <img src={site.logo} alt="" className="brand-logo" /> : null}
      {showText ? (
        <>
          {!showImage && <span className="brand-dot" />}
          {name}
        </>
      ) : null}
    </NavLink>
