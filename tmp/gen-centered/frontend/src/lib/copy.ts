...
const personalEn: SiteCopy = {
  ...
  projects: [
    { name: 'Nimbus Notes', description: 'A minimal note-taking app with offline sync.', tags: ['React', 'PWA'], image: 'https://picsum.photos/seed/nimbus/600/400' },
    { name: 'Orbit Dashboard', description: 'Analytics dashboard with realtime charts.', tags: ['TypeScript', 'Charts'], image: 'https://picsum.photos/seed/orbit/600/400' },
    { name: 'Fable Landing', description: 'Story-driven landing page for an indie game.', tags: ['Animation', 'CSS'], image: 'https://picsum.photos/seed/fable/600/400' },
    { name: 'Ledger Lite', description: 'Personal finance tracker that respects privacy.', tags: ['React', 'API'], image: 'https://picsum.photos/seed/ledger/600/400' }
  ],
  servicesTitle: '',
  services: [],
  team: []
...
const personalFa: SiteCopy = {
  ...
  projects: [
    { name: 'نیمبوس نوتس', description: 'اپ یادداشت مینیمال با همگام‌سازی آفلاین.', tags: ['ری‌اکت', 'PWA'], image: 'https://picsum.photos/seed/nimbus/600/400' },
    { name: 'اوربین داشبورد', description: 'داشبورد تحلیلی با نمودارهای زنده.', tags: ['تایپ‌اسکریپت', 'نمودار'], image: 'https://picsum.photos/seed/orbit/600/400' },
    { name: 'فِیبل لندینگ', description: 'صفحه فرود داستان‌محور برای یک بازی مستقل.', tags: ['انیمیشن', 'CSS'], image: 'https://picsum.photos/seed/fable/600/400' },
    { name: 'لجر لایت', description: 'مدیریت مالی شخصی با حفظ حریم خصوصی.', tags: ['ری‌اکت', 'API'], image: 'https://picsum.photos/seed/ledger/600/400' }
  ],
  servicesTitle: '',
  services: [],
  team: []
